...
classdef Belajar_HVO3_Majemuk < matlab.System    
...
%        maxSpeed = 1.5;
    ...
    methods
        %konstruktor
        function obj = Belajar_HVO3_Majemuk(varargin)
        ...
        function [sudutHaluan] = menghitungHaluanBebasBenturan_ASLINYA(obj,~)
...
%                 if indeknya(indek) > 3 && indeknya(indek) < 6 %9 titik
    ...
    %                        dataJarak(indeknya(indek)+5) > jarakAman
        ...
        function [kecepatanLinear, kecepatanAngular] = menghitungKecepatanBebasBenturan(obj,vel, ...
            ...
            kecepatanAngular = obj.menghitungHaluanBebasBenturan(himpunanJarak,fov,jarakAktif,resolusi);
        end
