%% @rumahTalon, Senin 10 Februari 2020, 17:11
% % % %% class utk uji Belajar_rs_mrsObstacleAvoidance.m dgn VFH
...
%         end  
    ...
    methods (Access = public) 
        ...
        function setupVisualization(obj)
            ...
            warna3 = ['r', 'g', 'b', 'y', 'm', 'c', 'k', 'k', 'b', 'y', 'b', 'y'];
...
%                                'Color','b','FontWeight','bold');
                    ...
                    elseif rIdx == 11
                            obj.IdHandles{rIdx} = text(0,0,'target', ... 
                               'Color','b','FontWeight','bold');
                    elseif rIdx == 12
                            obj.IdHandles{rIdx} = text(0,0,'statis', ... 
                               'Color','b','FontWeight','bold');
%                     elseif rIdx == 13
%                             obj.IdHandles{rIdx} = text(0,0,'statis', ... 
%                                'Color','b','FontWeight','bold');
            ...
            % kode di bawah ini dipakai utk objek berjumlah 10
                leg = legend( ...
                    [ ...
                        ...
                        obj.TrajHandle{11}, obj.TrajHandle{12} ...
                    ], ...                
                    'Ego-Robot','Target#1', ...
                    'Obstacle#1','Target#2',...
                    'Obstacle#2','Target#3', ...                
                    'Obstacle#3','Obstacle#5', ...
                    'Obstacle#4','Obstacle#6', ...
