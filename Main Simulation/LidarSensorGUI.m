classdef LidarSensorGUI < matlab.System & matlab.system.mixin.CustomIcon & matlab.system.mixin.Propagates
    ...
    methods
        ...
        function obj = LidarSensorGUI(varargin)
            if nargin > 1
        ...
        function setEnvironment(obj,env)
            if isa(env,'MultiRobotEnvGUI') %% Sabtu8Mei2021,12.33PM @rumahTalon
                obj.env = env;
